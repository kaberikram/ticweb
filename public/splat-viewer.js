...
function addStickerPlanes(app) {
  ...
  function onBothLoaded() {
    ...
    const configs = [
      { pos: [-0.6,  2.1, -4.5], rot: [-90, 0, -15], scale: [1.60, 1, 0.58], mat: matDream }, // upper
      { pos: [-0.1,  0.8, -4.5], rot: [-90, 0,  10], scale: [1.60, 1, 0.58], mat: matHere  }, // mid-right
      { pos: [-0.4, -0.4, -4.8], rot: [-90, 0,  -8], scale: [1.60, 1, 0.58], mat: matDream }, // mid-left
      { pos: [-0.6,  1.3, -4.3], rot: [-90, 0,  13], scale: [1.44, 1, 0.52], mat: matHere  }, // upper-left
      { pos: [-0.2, -1.3, -5.0], rot: [-90, 0, -17], scale: [1.60, 1, 0.58], mat: matDream }, // lower
      { pos: [ 0.1,  1.7, -4.2], rot: [-90, 0,   6], scale: [1.44, 1, 0.52], mat: matHere  }, // upper-right
    ]
